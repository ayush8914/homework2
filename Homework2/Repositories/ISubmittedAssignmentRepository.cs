...
namespace Homework2.Repositories
{
    public interface ISubmittedAssignmentRepository
    {
        ...
        IEnumerable<ClassroomUsers> GetPeopleNotSubmitted(int assignmentId);
    ...
    public class SQLSubmittedAssignmentRepository : ISubmittedAssignmentRepository
    {
        ...
        IEnumerable<ClassroomUsers> ISubmittedAssignmentRepository.GetPeopleNotSubmitted(int assignmentId)
        {
            ...
            .Select(c => c.AppUserID)
                .ToList();
            IEnumerable<ClassroomUsers> notSubmitted = context.ClassroomUsers
