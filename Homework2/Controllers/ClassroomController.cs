    ...
    {   
        ...
        public IActionResult Create(Classroom model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ClassroomUsers newClassUser = new ClassroomUsers
                {
                ...
                return RedirectToAction("Home","Classroom", new { id = newClass.ID, loadPartial = "BlackBoard" });
            }
            return View();
        }
        [Authorize]
       ...
       [HttpPost, ActionName("Delete")]
        ...
        {     
            ...
            ClassroomUsers classUser = _classUserRepo.GetClassroomUser(id, userId);
        ...
        public IActionResult InviteStudents(string ClassId, string emails)
        {
            ...
            string[] Emails = emails.Split(" ");
                string    Subject = "Invite to "+classroom.title+" Blackboard";
              string htmlmsg   = "<div>" +
                        "Hello Student," +
                        "<br/><br/>" +
        ...
        public async Task<IActionResult> NewAssignment(ClassroomHomeViewModel model)
        {
            string Id = null;
            if (_signInManager.IsSignedIn(HttpContext.User))
            {
            ...
            return RedirectToAction("Home", new { id = model.AssignmentViewModel.ClassId, loadPartial = "BlackBoard" });
        }
        ...
        public IActionResult ViewSubmissions(int id)
        {
            ...
            ClassroomUsers classroomUser = _classUserRepo.GetClassroomUser((int)assignment.ClassroomID, userId);
            ...
            if (classroomUser.Role == "Mentor")
            {
                ...
                IEnumerable<ClassroomUsers> notSubmitted = _submittedAssignmentRepo.GetPeopleNotSubmitted(id);
        ...
        public IActionResult AddComment(ClassroomHomeViewModel model)
        {
            ...
            if (_signInManager.IsSignedIn(HttpContext.User))
            {
                ...
                classId = (int)_boardRepo.GetBlackBoard((int)model.Comment.BlackBoardId).ClassroomId;
